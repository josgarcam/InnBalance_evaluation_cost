...
def data_extraction(component, query_conditions, test):
    ...
    if test == False:
        ...
        ob = db.session.query(component).filter(component.manuforiented == query_conditions.get('manuforiented')).\
            filter(component.origin == 'AT').all()
